									...
									<div class="container">
									    ...
									    <div class="tabs-container">
											<ul class="nav nav-tabs">
												<li class="active"><a data-toggle="tab" href="#tab-1">Core Java</a></li>
												<li class=""><a data-toggle="tab" href="#tab-2">Java 8 API</a></li>
												<li class=""><a data-toggle="tab" href="#tab-3">JQuery</a></li>
												<li class=""><a data-toggle="tab" href="#tab-4">PHP</a></li>
												<li class=""><a data-toggle="tab" href="#tab-5">JavaScript</a></li>
												<li class=""><a data-toggle="tab" href="#tab-6">Dot Net</a></li>
											</ul>
